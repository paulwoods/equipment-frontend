        ...
        <div className="min-h-screen bg-[var(--background)] flex items-center justify-center p-4">
            <div className="max-w-4xl w-full">
                <div className="text-center mb-12">
                    <h1 className="text-4xl sm:text-5xl font-extrabold text-[var(--foreground)] mb-4 tracking-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Link
                        to="/dashboard"
                        className="group bg-[var(--card)] p-8 rounded-2xl shadow-sm border border-[var(--border)] hover:border-indigo-500 hover:shadow-md transition-all duration-300 flex flex-col items-center text-center"
                    >
                        <div
                        ...
                        <h2 className="text-2xl font-bold text-[var(--foreground)] mb-3">Dashboard</h2>
                    ...
                    <Link
                        to="/equipment"
                        className="group bg-[var(--card)] p-8 rounded-2xl shadow-sm border border-[var(--border)] hover:border-blue-500 hover:shadow-md transition-all duration-300 flex flex-col items-center text-center"
                    >
                        <div
                        ...
                        <h2 className="text-2xl font-bold text-[var(--foreground)] mb-3">Equipment</h2>
                        <p className="text-[var(--muted-foreground)] mb-6 flex-grow">
